...
public:
    ...
    // Render effects
    RenderEffects compute_render_effects(SDL_Point world, float asset_screen_height, 
    ...
    SDL_Point get_screen_center() const { 
        return SDL_Point{
            static_cast<int>(smoothed_center_.x), 
            static_cast<int>(smoothed_center_.y)
        }; 
    }
