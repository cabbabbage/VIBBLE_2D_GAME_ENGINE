...
public:
    ...
    bool set_layer_room_range(int index, int min_rooms, int max_rooms);
    ...
    bool set_candidate_instance_range(int layer_index, int candidate_index,
...
private:
    ...
    void clamp_layer_ranges(nlohmann::json& layer) const;
