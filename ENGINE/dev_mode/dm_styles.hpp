...
namespace dm {
inline SDL_Color rgba(Uint8 r, Uint8 g, Uint8 b, Uint8 a = 255) { return SDL_Color{r,g,b,a}; }
#ifdef _WIN32
...
struct DMLabelStyle {
    ...
    int font_size;
    SDL_Color color;
    TTF_Font* open_font() const { return TTF_OpenFont(font_path.c_str(), font_size); }
};
