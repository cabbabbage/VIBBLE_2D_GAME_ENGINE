...
/**
 * Summary
Add a centralized random number generator so all randomness in the engine uses the same seed. This allows reproducibility when a seed is given and consistent behavior across systems.
