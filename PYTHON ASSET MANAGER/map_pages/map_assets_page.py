...
from shared.batch_asset_editor import BatchAssetEditor  # Ensure this class reads/writes jitter properly
...
class MapAssetsPage(ttk.Frame):
    ...
    def _save_json(self):
        if not self.json_path:
            return
        self.data["batch_assets"] = self.editor.save()  # Forces current editor state to update data
        try:
